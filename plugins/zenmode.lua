    ...
    opts = {
        ...
        on_open = function() -- disable diagnostics and indent blankline
            require("astronvim.utils").set_mappings {
                n = {
                    ["<leader>n"] = {
                        "<cmd>ZenMode<CR>",
                        desc = "Centers and mutes code",
                    },
                },
            }
            vim.g.diagnostics_enabled_old = vim.g.diagnostics_enabled
            vim.g.status_diagnostics_enabled_old =
                vim.g.status_diagnostics_enabled
        ...
        on_close = function() -- restore diagnostics and indent blankline
            ...
            vim.diagnostic.config(
                lsp.diagnostics[vim.g.diagnostics_enabled and "on" or "off"]
            )
